...
from src.build_query_graph.main_Luo_for_train import main
...
if __name__ == "__main__":
    ...
    fileNormal = '/data/candidates/temp/CCKS2019_Luo_test_top' + str(topk) + '_0429DNS_'
    entityLinkingFile = BASE_DIR + '/data/dataset/CCKS2019/EL_test_实体识别结果_加长串_baike_19Order_0624reberta_top3.json'  # pjzhang之前取得的SOTA结果
    '''CCKS2019-Comp'''
    # fileName = BASE_DIR + '/data/dataset/CCKS2019_CompType/que_newType_test.txt'  
    # fileNormal = '/data/candidates/temp/CCKS2019_Comp_Luo_test_top' + str(topk) + '_0429DNS_'
    # entityLinkingFile = BASE_DIR + '/data/dataset/CCKS2019/EL_test_实体识别结果_加长串_baike_19Order_0624reberta_top3.json'  # pjzhang之前取得的SOTA结果
    ...
    if(N == 1):
        ...
        main(entityLinkingFile, questions, outFile, simOfQueRel, que2type,'test')
    else:
        for i in range(N):
