...
def main(entityLinkingFile, questions, outFile, simOfQueRel, que2type,mode='train'):
    ...
    que2entitylinkings = addMentionToLinking(que2entitylinkings)
    ...
    for i, que in enumerate(questions[:]):
        ...
        if(que in que2entitylinkings and len(que2entitylinkings[que]) > 0):
            ...
            if(queType == 'xcompareJudge'):
                ...
                queryGraphs = searchPath.generateQueryGraphYhi(entitys=entitys, virtualEntitys=virtualEntitys,
...
if __name__ == "__main__":
    ...
    fileName = BASE_DIR + '/data/dataset/CCKS2019/que_newType_train.txt'
    ...
    fileNormal = '/data/candidates/temp/0504_CCKS2019_CompType_Yhi_train_' + str(topk) + '_0429DNS_'
    entityLinkingFile = BASE_DIR + '/data/dataset/CCKS2019/EL_train_data_ml.json'
    # fileNormal = '/data/candidates/temp/0504_CCKS2019_CompType_Yhi_dev_' + str(topk) + '_0429DNS_'
    # entityLinkingFile = BASE_DIR + '/data/dataset/CCKS2019/EL_valid_data_ml.json'
    if(N == 1):
