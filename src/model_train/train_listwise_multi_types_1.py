...
def test(best_model_dir_name, fout_res):
    ...
    file_name1 = '/'.join(best_model_dir_name.split('/')[0:-1]) + '/prediction_var_noentity_gold-ml'
    # import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    # client = WatchClient(id="pointwisexx", gpus=[0],
    ...
    # for train_batch_size in [20, 18, 16, 14]:
    for steps in [100]:
        # for N in [5, 10, 20]:
        for N in [20]:
        # for N in [100, 80, 60, 40]:
        # N = 5
        # for train_batch_size in [4, 6, 8]:
        # for train_batch_size in [1]:
            train_batch_size = 1
        # for N in [20, 15]:
        # for steps in [100]:
        # for seed in [66, 666, 6666, 66666, 10000]:
            logger = logging.getLogger(__name__)
            print(seed)
            os.environ["CUDA_VISIBLE_DEVICES"] = '6'
            parser = ArgumentParser(description = 'For KBQA')
            # re_ckbqa/ckbqa/data/train_data/0524_CCKS2022_self/testset_model_data_self_4_300_ELgold_0610.txt
            parser.add_argument("--data_dir",default=BASE_DIR + '/data/train_data/0524_CCKS2022_self/',type=str)
            parser.add_argument("--bert_model", default='/data4/cytan/ckbqa/bert_base_chinese', type=str)
            parser.add_argument("--bert_vocab", default='/data4/cytan/ckbqa/bert_base_chinese', type=str)
            parser.add_argument("--task_name",default='mrpc',type=str,help="The name of the task to train.")
            parser.add_argument("--output_dir",default='models/0603_CCKS2022_self_Ours-baseline_entPathHead_1e-5/' + str(N) +\
                                 '_' + str(train_batch_size) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
            parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
            
            parser.add_argument("--T_file_name",default='train_neg' + str(N) + '_copy3.txt',type=str)
            parser.add_argument("--v_file_name",default='dev_20%_neg100.txt',type=str)
            parser.add_argument("--t_file_name",default='testset_model_data_self_4_300_ELgold_0610.txt',type=str)
            ...
            # exit()
            # best_model_dir_name = '/data4/cytan/re_ckbqa/ckbqa/src/model_train/models/0602_CCKS2022_self_Ours-baseline_entPathHead_5e-6/20_1_42_100/0.9833870023419203_0.9025006485649493_3'
            # score_file = '/data4/cytan/re_ckbqa/ckbqa/data/candidates/0524_self/seq/0610_self_test-gold_300_allHard_entPath.score'
            # infer(best_model_dir_name,score_file)

            best_model_dir_name = main(fout_res)
            # best_model_dir_name = '/data2/yhjia/kbqa/ckbqa/src/model_train/models/5641_listwise_bert_train65000examples_devneg50_seq150_CE_group_5_2_42_100/0.9853239800627653_0.8023528098790463_2'
            # best_model_dir_name = '/data2/yhjia/kbqa/ckbqa/src/model_train/models/listwise_train65000examples_devneg50_CE_group_5_42_100/0.987631530367362_0.7755032706888477_2'
            # best_model_dir_name = '/data2/yhjia/kbqa/ckbqa/src/model_train/models/listwise_train65000examples_devneg50_seq150_CE_group_5_42_100/0.9874469263429942_0.7937296151054283_2'
            # best_model_dir_name = '/data4/cytan/re_ckbqa/ckbqa/src/model_train/models/0428_entityPathHead/30_1_42_100/0.9952380952380953_0.851886152119887_3'
